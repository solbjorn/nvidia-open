...
compile_test() {
    case "$1" in
        ...
        vfio_register_emulated_iommu_dev)
            ...
            CODE="
            #include <linux/vfio.h>
            void conftest_vfio_register_emulated_iommu_dev(void) {
                vfio_register_emulated_iommu_dev();
            }"
       ...
       nvhost_dma_fence_unpack)
        ...
        of_find_node_by_phandle)
            ...
            if [ -f conftest$$.o ]; then
                ...
                CODE="
                #include <linux/of.h>
                void conftest_of_find_node_by_phandle(void) {
                    of_find_node_by_phandle();
                }"
        ...
        of_node_to_nid)
            ...
            if [ -f conftest$$.o ]; then
                ...
                #include <linux/of.h>
                void conftest_of_node_to_nid(void) {
                    of_node_to_nid();
                }"
        ...
        pnv_pci_get_npu_dev)
            ...
            CODE="
            #include <linux/pci.h>
            void conftest_pnv_pci_get_npu_dev(void) {
                pnv_pci_get_npu_dev();
            }"
        ...
        vm_insert_pfn_prot)
            ...
            CODE="
            #include <linux/mm.h>
            void conftest_vm_insert_pfn_prot(void) {
                vm_insert_pfn_prot();
            }"
        ...
        vmf_insert_pfn_prot)
            ...
            CODE="
            #include <linux/mm.h>
            void conftest_vmf_insert_pfn_prot(void) {
                vmf_insert_pfn_prot();
            }"
        ...
        pci_stop_and_remove_bus_device)
            ...
            #include <linux/types.h>
            #include <linux/pci.h>
            void conftest_pci_stop_and_remove_bus_device(void) {
                pci_stop_and_remove_bus_device();
            }"
        ...
        enable_apicv)
            ...
            bool is_enable_apicv_present(void) {
                return enable_apicv;
            }"
        ...
        full_name_hash)
            ...
            void conftest_full_name_hash(void) {
                (void)full_name_hash(NULL, NULL, 0);
            }" > conftest$$.c
        ...
        add_memory_driver_managed)
            ...
            void conftest_add_memory_driver_managed(void) {
                add_memory_driver_managed();
            }"
        ...
        offline_and_remove_memory)
            ...
            CODE="
            #include <linux/memory_hotplug.h>
            void conftest_offline_and_remove_memory(void) {
                offline_and_remove_memory();
            }"
        ...
        device_property_read_u64)
            ...
            void conftest_device_property_read_u64(void) {
                device_property_read_u64();
            }"
        ...
        of_property_count_elems_of_size)
            ...
            if [ -f conftest$$.o ]; then
                ...
                CODE="
                #include <linux/of.h>
                void conftest_of_property_count_elems_of_size(void) {
                    of_property_count_elems_of_size();
                }"
        ...
        of_property_read_variable_u8_array)
            ...
            if [ -f conftest$$.o ]; then
                ...
                CODE="
                #include <linux/of.h>
                void conftest_of_property_read_variable_u8_array(void) {
                    of_property_read_variable_u8_array();
                }"
        ...
        of_property_read_variable_u32_array)
            ...
            if [ -f conftest$$.o ]; then
                ...
                CODE="
                #include <linux/of.h>
                void conftest_of_property_read_variable_u32_array(void) {
                    of_property_read_variable_u32_array();
                }"
...
case "$5" in
    ...
    cc_version_check)
        ...
        echo "
        #ifdef __clang__
        #define __MAJOR __clang_major__
        #define __MINOR __clang_minor__
        #else
        #define __MAJOR __GNUC__
        #define __MINOR __GNUC_MINOR__
        #endif
        #if (__MAJOR != ${kernel_cc_major}) || (__MINOR != ${kernel_cc_minor})
