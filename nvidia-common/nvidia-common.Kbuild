...
NVIDIA_COMMON_OBJECTS := nvidia-common/nv-kthread-q.o
NVIDIA_COMMON_OBJECTS += nvidia-common/nv-kthread-q-selftest.o
NVIDIA_COMMON_OBJECTS += nvidia-common/nvstatus.o
