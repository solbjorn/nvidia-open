...
#define __NVOC_CB_TYPE P2PTokenShare
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_P2PTokenShare, __nvoc_dtor_P2PTokenShare);

static const struct NVOC_RTTI __nvoc_rtti_P2PTokenShare_P2PTokenShare = {
    /*pClassDef=*/          &__nvoc_class_def_P2PTokenShare,
    /*dtor=*/               __nvoc_dtor_P2PTokenShare_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_P2PTokenShare =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_P2PTokenShare_ctor,
