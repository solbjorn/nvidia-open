...
#define __NVOC_CB_TYPE GpuUserSharedData
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_GpuUserSharedData, __nvoc_dtor_GpuUserSharedData);
...
static const struct NVOC_RTTI __nvoc_rtti_GpuUserSharedData_GpuUserSharedData = {
    ...
    /*dtor=*/               __nvoc_dtor_GpuUserSharedData_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_GpuUserSharedData =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_GpuUserSharedData_ctor,
