...
#define __NVOC_CB_TYPE IoAperture
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_IoAperture,
		     __nvoc_dtor_IoAperture);

static const struct NVOC_RTTI __nvoc_rtti_IoAperture_IoAperture = {
    /*pClassDef=*/          &__nvoc_class_def_IoAperture,
    /*dtor=*/               __nvoc_dtor_IoAperture_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_IoAperture =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_IoAperture_ctor,
...
#define __NVOC_CB_TYPE SwBcAperture
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_SwBcAperture,
		     __nvoc_dtor_SwBcAperture);

static const struct NVOC_RTTI __nvoc_rtti_SwBcAperture_SwBcAperture = {
    /*pClassDef=*/          &__nvoc_class_def_SwBcAperture,
    /*dtor=*/               __nvoc_dtor_SwBcAperture_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_SwBcAperture =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_SwBcAperture_ctor,
