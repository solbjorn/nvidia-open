...
#define __NVOC_CB_TYPE KernelCcu
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_KernelCcu, __nvoc_dtor_KernelCcu);

static const struct NVOC_RTTI __nvoc_rtti_KernelCcu_KernelCcu = {
    /*pClassDef=*/          &__nvoc_class_def_KernelCcu,
    /*dtor=*/               __nvoc_dtor_KernelCcu_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_KernelCcu = 
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_KernelCcu_ctor,
