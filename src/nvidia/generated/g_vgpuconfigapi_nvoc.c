...
#define __NVOC_CB_TYPE VgpuConfigApi
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_VgpuConfigApi,
		     __nvoc_dtor_VgpuConfigApi);

static const struct NVOC_RTTI __nvoc_rtti_VgpuConfigApi_VgpuConfigApi = {
    /*pClassDef=*/          &__nvoc_class_def_VgpuConfigApi,
    /*dtor=*/               __nvoc_dtor_VgpuConfigApi_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_VgpuConfigApi =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_VgpuConfigApi_ctor,
...
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigSetInfo_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigEnumerateVgpuPerPgpu_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigGetVgpuTypeInfo_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigGetSupportedVgpuTypes_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigGetCreatableVgpuTypes_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigEventSetNotification_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigNotifyStart_IMPL);
NVOC_BUILD_CALLBACK_1(vgpuconfigapiCtrlCmdVgpuConfigMdevRegister_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigSetVgpuInstanceEncoderCapacity_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigGetVgpuFbUsage_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigGetMigrationCap_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigGetHostFbReservation_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigGetPgpuMetadataString_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigGetDoorbellEmulationSupport_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigGetFreeSwizzId_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdPgpuGetMultiVgpuSupportInfo_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdGetVgpuDriversCaps_IMPL);
NVOC_BUILD_CALLBACK(vgpuconfigapiCtrlCmdVgpuConfigSetPgpuInfo_IMPL);
...
static const struct NVOC_EXPORTED_METHOD_DEF __nvoc_exported_method_def_VgpuConfigApi[] =
{
    {               /*  [0] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigSetInfo_IMPL_cb,
    ...
    {               /*  [1] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigEnumerateVgpuPerPgpu_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [2] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigGetVgpuTypeInfo_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [3] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigGetSupportedVgpuTypes_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [4] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigGetCreatableVgpuTypes_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [5] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigEventSetNotification_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [6] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigNotifyStart_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [7] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigMdevRegister_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [8] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigSetVgpuInstanceEncoderCapacity_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [9] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigGetVgpuFbUsage_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [10] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigGetMigrationCap_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [11] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigGetHostFbReservation_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [12] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigGetPgpuMetadataString_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [13] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigGetDoorbellEmulationSupport_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [14] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigGetFreeSwizzId_IMPL_cb,
    ...
    {               /*  [15] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdPgpuGetMultiVgpuSupportInfo_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [16] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdGetVgpuDriversCaps_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [17] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vgpuconfigapiCtrlCmdVgpuConfigSetPgpuInfo_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x4u)
        /*flags=*/      0x4u,
        /*accessRight=*/0x0u,
