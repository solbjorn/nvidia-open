...
#define __NVOC_CB_TYPE KernelHostVgpuDeviceShr
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_KernelHostVgpuDeviceShr,
		     __nvoc_dtor_KernelHostVgpuDeviceShr);
...
static const struct NVOC_RTTI __nvoc_rtti_KernelHostVgpuDeviceShr_KernelHostVgpuDeviceShr = {
    ...
    /*dtor=*/               __nvoc_dtor_KernelHostVgpuDeviceShr_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_KernelHostVgpuDeviceShr =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_KernelHostVgpuDeviceShr_ctor,
...
#define __NVOC_CB_TYPE KernelHostVgpuDeviceApi
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_KernelHostVgpuDeviceApi, __nvoc_dtor_KernelHostVgpuDeviceApi);
...
static const struct NVOC_RTTI __nvoc_rtti_KernelHostVgpuDeviceApi_KernelHostVgpuDeviceApi = {
    ...
    /*dtor=*/               __nvoc_dtor_KernelHostVgpuDeviceApi_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_KernelHostVgpuDeviceApi =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_KernelHostVgpuDeviceApi_ctor,
...
NVOC_BUILD_CALLBACK(kernelhostvgpudeviceapiCtrlCmdSetVgpuDeviceInfo_IMPL);
NVOC_BUILD_CALLBACK(kernelhostvgpudeviceapiCtrlCmdSetVgpuGuestLifeCycleState_IMPL);
NVOC_BUILD_CALLBACK(kernelhostvgpudeviceapiCtrlCmdSetOfflinedPagePatchInfo_IMPL);
NVOC_BUILD_CALLBACK(kernelhostvgpudeviceapiCtrlCmdVfConfigSpaceAccess_IMPL);
NVOC_BUILD_CALLBACK(kernelhostvgpudeviceapiCtrlCmdBindFecsEvtbuf_IMPL);
NVOC_BUILD_CALLBACK(kernelhostvgpudeviceapiCtrlCmdTriggerPrivDoorbell_IMPL);
NVOC_BUILD_CALLBACK(kernelhostvgpudeviceapiCtrlCmdEventSetNotification_IMPL);
NVOC_BUILD_CALLBACK(kernelhostvgpudeviceapiCtrlCmdSetSriovState_IMPL);
NVOC_BUILD_CALLBACK(kernelhostvgpudeviceapiCtrlCmdSetGuestId_IMPL);
NVOC_BUILD_CALLBACK(kernelhostvgpudeviceapiCtrlCmdGetBarMappingRanges_IMPL);
...
static const struct NVOC_EXPORTED_METHOD_DEF __nvoc_exported_method_def_KernelHostVgpuDeviceApi[] =
{
    {               /*  [0] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      kernelhostvgpudeviceapiCtrlCmdSetVgpuDeviceInfo_IMPL_cb,
    ...
    {               /*  [1] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      kernelhostvgpudeviceapiCtrlCmdSetVgpuGuestLifeCycleState_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [2] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      kernelhostvgpudeviceapiCtrlCmdSetOfflinedPagePatchInfo_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [3] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      kernelhostvgpudeviceapiCtrlCmdVfConfigSpaceAccess_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [4] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      kernelhostvgpudeviceapiCtrlCmdBindFecsEvtbuf_IMPL_cb,
    ...
    {               /*  [5] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      kernelhostvgpudeviceapiCtrlCmdTriggerPrivDoorbell_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [6] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      kernelhostvgpudeviceapiCtrlCmdEventSetNotification_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [7] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      kernelhostvgpudeviceapiCtrlCmdSetSriovState_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [8] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      kernelhostvgpudeviceapiCtrlCmdSetGuestId_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
    ...
    {               /*  [9] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      kernelhostvgpudeviceapiCtrlCmdGetBarMappingRanges_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
