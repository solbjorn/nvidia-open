...
#define __NVOC_CB_TYPE MemoryManager
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_MemoryManager, __nvoc_dtor_MemoryManager);

static const struct NVOC_RTTI __nvoc_rtti_MemoryManager_MemoryManager = {
    /*pClassDef=*/          &__nvoc_class_def_MemoryManager,
    /*dtor=*/               __nvoc_dtor_MemoryManager_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_MemoryManager =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_MemoryManager_ctor,
