...
#define __NVOC_CB_TYPE KernelVgpuMgr
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_KernelVgpuMgr,
		     __nvoc_dtor_KernelVgpuMgr);

static const struct NVOC_RTTI __nvoc_rtti_KernelVgpuMgr_KernelVgpuMgr = {
    /*pClassDef=*/          &__nvoc_class_def_KernelVgpuMgr,
    /*dtor=*/               __nvoc_dtor_KernelVgpuMgr_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_KernelVgpuMgr =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_KernelVgpuMgr_ctor,
