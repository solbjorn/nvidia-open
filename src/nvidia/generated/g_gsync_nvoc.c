...
#define __NVOC_CB_TYPE OBJGSYNCMGR
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_OBJGSYNCMGR,
		     __nvoc_dtor_OBJGSYNCMGR);

static const struct NVOC_RTTI __nvoc_rtti_OBJGSYNCMGR_OBJGSYNCMGR = {
    /*pClassDef=*/          &__nvoc_class_def_OBJGSYNCMGR,
    /*dtor=*/               __nvoc_dtor_OBJGSYNCMGR_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_OBJGSYNCMGR =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_OBJGSYNCMGR_ctor,
