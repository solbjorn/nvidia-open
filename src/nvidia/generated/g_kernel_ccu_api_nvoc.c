...
#define __NVOC_CB_TYPE KernelCcuApi
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_KernelCcuApi, __nvoc_dtor_KernelCcuApi);

static const struct NVOC_RTTI __nvoc_rtti_KernelCcuApi_KernelCcuApi = {
    /*pClassDef=*/          &__nvoc_class_def_KernelCcuApi,
    /*dtor=*/               __nvoc_dtor_KernelCcuApi_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_KernelCcuApi =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_KernelCcuApi_ctor,
...
static const struct NVOC_EXPORTED_METHOD_DEF __nvoc_exported_method_def_KernelCcuApi[] =
{
    {               /*  [0] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      kccuapiCtrlCmdSubscribe_IMPL_cb,
    ...
    {               /*  [1] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      kccuapiCtrlCmdUnsubscribe_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x10u)
        /*flags=*/      0x10u,
        /*accessRight=*/0x0u,
