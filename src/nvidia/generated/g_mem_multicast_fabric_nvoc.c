...
#define __NVOC_CB_TYPE MemoryMulticastFabric
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_MemoryMulticastFabric,
		     __nvoc_dtor_MemoryMulticastFabric);
...
static const struct NVOC_RTTI __nvoc_rtti_MemoryMulticastFabric_MemoryMulticastFabric = {
    ...
    /*dtor=*/               __nvoc_dtor_MemoryMulticastFabric_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_MemoryMulticastFabric =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_MemoryMulticastFabric_ctor,
...
NVOC_BUILD_CALLBACK(memorymulticastfabricCtrlGetInfo_IMPL);
NVOC_BUILD_CALLBACK(memorymulticastfabricCtrlAttachMem_IMPL);
NVOC_BUILD_CALLBACK(memorymulticastfabricCtrlRegisterEvent_IMPL);
NVOC_BUILD_CALLBACK(memorymulticastfabricCtrlAttachGpu_IMPL);
NVOC_BUILD_CALLBACK(memorymulticastfabricCtrlDetachMem_IMPL);
...
static const struct NVOC_EXPORTED_METHOD_DEF __nvoc_exported_method_def_MemoryMulticastFabric[] =
{
    {               /*  [0] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      memorymulticastfabricCtrlGetInfo_IMPL_cb,
    ...
    {               /*  [1] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      memorymulticastfabricCtrlAttachMem_IMPL_cb,
    ...
    {               /*  [2] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      memorymulticastfabricCtrlRegisterEvent_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x811u)
        /*flags=*/      0x811u,
        /*accessRight=*/0x0u,
        /*methodId=*/   0xfd0103u,
    ...
    {               /*  [3] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      memorymulticastfabricCtrlAttachGpu_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x810u)
        /*flags=*/      0x810u,
        /*accessRight=*/0x0u,
        /*methodId=*/   0xfd0104u,
    ...
    {               /*  [4] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      memorymulticastfabricCtrlDetachMem_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x810u)
        /*flags=*/      0x810u,
        /*accessRight=*/0x0u,
        /*methodId=*/   0xfd0105u,
