...
#define __NVOC_CB_TYPE VidmemAccessBitBuffer
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_VidmemAccessBitBuffer,
		     __nvoc_dtor_VidmemAccessBitBuffer);
...
static const struct NVOC_RTTI __nvoc_rtti_VidmemAccessBitBuffer_VidmemAccessBitBuffer = {
    ...
    /*dtor=*/               __nvoc_dtor_VidmemAccessBitBuffer_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_VidmemAccessBitBuffer =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_VidmemAccessBitBuffer_ctor,
...
NVOC_BUILD_CALLBACK(vidmemAccessBitBufCtrlCmdVidmemAccessBitDump_IMPL);
...
static const struct NVOC_EXPORTED_METHOD_DEF __nvoc_exported_method_def_VidmemAccessBitBuffer[] =
{
    {               /*  [0] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      vidmemAccessBitBufCtrlCmdVidmemAccessBitDump_IMPL_cb,
