...
#define __NVOC_CB_TYPE OBJHYPERVISOR
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_OBJHYPERVISOR, __nvoc_dtor_OBJHYPERVISOR);

static const struct NVOC_RTTI __nvoc_rtti_OBJHYPERVISOR_OBJHYPERVISOR = {
    /*pClassDef=*/          &__nvoc_class_def_OBJHYPERVISOR,
    /*dtor=*/               __nvoc_dtor_OBJHYPERVISOR_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_OBJHYPERVISOR =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_OBJHYPERVISOR_ctor,
