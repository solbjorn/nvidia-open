...
#define __NVOC_CB_TYPE MemoryMapper
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_MemoryMapper,
		     __nvoc_dtor_MemoryMapper);

static const struct NVOC_RTTI __nvoc_rtti_MemoryMapper_MemoryMapper = {
    /*pClassDef=*/          &__nvoc_class_def_MemoryMapper,
    /*dtor=*/               __nvoc_dtor_MemoryMapper_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_MemoryMapper =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_MemoryMapper_ctor,
...
NVOC_BUILD_CALLBACK(memmapperCtrlCmdSubmitPagingOperations_IMPL);
...
static const struct NVOC_EXPORTED_METHOD_DEF __nvoc_exported_method_def_MemoryMapper[] =
{
    {               /*  [0] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      memmapperCtrlCmdSubmitPagingOperations_IMPL_cb,
