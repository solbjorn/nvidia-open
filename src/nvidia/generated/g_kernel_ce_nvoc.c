...
#define __NVOC_CB_TYPE KernelCE
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_KernelCE, __nvoc_dtor_KernelCE);

static const struct NVOC_RTTI __nvoc_rtti_KernelCE_KernelCE = {
    /*pClassDef=*/          &__nvoc_class_def_KernelCE,
    /*dtor=*/               __nvoc_dtor_KernelCE_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_KernelCE =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_KernelCE_ctor,
