...
#define __NVOC_CB_TYPE MemoryList
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_MemoryList,
		     __nvoc_dtor_MemoryList);

static const struct NVOC_RTTI __nvoc_rtti_MemoryList_MemoryList = {
    /*pClassDef=*/          &__nvoc_class_def_MemoryList,
    /*dtor=*/               __nvoc_dtor_MemoryList_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_MemoryList =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_MemoryList_ctor,
