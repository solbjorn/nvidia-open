...
#define __NVOC_CB_TYPE OBJOS
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_OBJOS, __nvoc_dtor_OBJOS);

static const struct NVOC_RTTI __nvoc_rtti_OBJOS_OBJOS = {
    /*pClassDef=*/          &__nvoc_class_def_OBJOS,
    /*dtor=*/               __nvoc_dtor_OBJOS_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_OBJOS =
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_OBJOS_ctor,
