...
#define __NVOC_CB_TYPE KernelFsp
NVOC_BUILD_CTOR_DTOR(__nvoc_objCreateDynamic_KernelFsp, __nvoc_dtor_KernelFsp);

static const struct NVOC_RTTI __nvoc_rtti_KernelFsp_KernelFsp = {
    /*pClassDef=*/          &__nvoc_class_def_KernelFsp,
    /*dtor=*/               __nvoc_dtor_KernelFsp_dtor,
    /*offset=*/             0,
};
...
const struct NVOC_CLASS_DEF __nvoc_class_def_KernelFsp = 
{
    ...
    /*objCreatefn=*/        __nvoc_objCreateDynamic_KernelFsp_ctor,
