...
NVOC_BUILD_CALLBACK(memoryfabricCtrlAttachMem_IMPL);
NVOC_BUILD_CALLBACK(memoryfabricCtrlDetachMem_IMPL);
NVOC_BUILD_CALLBACK(memoryfabricCtrlGetNumAttachedMem_IMPL);
NVOC_BUILD_CALLBACK(memoryfabricCtrlGetAttachedMem_IMPL);
...
static const struct NVOC_EXPORTED_METHOD_DEF __nvoc_exported_method_def_MemoryFabric[] =
{
    ...
    {               /*  [2] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      memoryfabricCtrlAttachMem_IMPL_cb,
    ...
    {               /*  [3] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      memoryfabricCtrlDetachMem_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x8810u)
        /*flags=*/      0x8810u,
        /*accessRight=*/0x0u,
        /*methodId=*/   0xf80104u,
    ...
    {               /*  [4] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      memoryfabricCtrlGetNumAttachedMem_IMPL_cb,
#endif // NVOC_EXPORTED_METHOD_DISABLED_BY_FLAG(0x850u)
        /*flags=*/      0x850u,
        /*accessRight=*/0x0u,
        /*methodId=*/   0xf80105u,
    ...
    {               /*  [5] */
        ...
        /*pFunc=*/      NULL,
#else
        /*pFunc=*/      memoryfabricCtrlGetAttachedMem_IMPL_cb,
